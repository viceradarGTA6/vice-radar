...
const DATA = {
  ...
  news: [
    { id: "news_075", titolo: "Anche il giudice capo della Contea si oppone al piano Vice City", tipo: "ufficiale", categoria: "Annunci", data: "2026-09-05", testo: "Alle proteste di sceriffo e commissario contro il piano di rebranding in stile Vice City si è aggiunta anche Ariana Fajardo Orshan, giudice capo della Contea di Miami-Dade, che ha scritto alla sindaca Daniella Levine Cava chiedendo di escludere tribunali ed edifici giudiziari da qualsiasi branding legato a GTA6, ritenendo i temi del gioco incompatibili con ciò che quegli edifici rappresentano. L'ufficio della sindaca resta invece aperto alla proposta, vista come una possibile opportunità di visibilità ed entrate, senza però che sia stato ancora raggiunto un accordo formale." },
    { id: "news_074", titolo: "Un fan rintraccia l'appartamento reale di Jason e Lucia, ormai demolito", tipo: "rumor", categoria: "Ambientazione", data: "2026-08-30", testo: "Confrontando lo skyline visibile dalla finestra dell'appartamento di Jason e Lucia con le mappe storiche di Google Maps, un fan ha rintracciato l'edificio che avrebbe ispirato la loro casa a Vice City: il Belmar Condominium, un piccolo condominio di 13 unità nel quartiere di Edgewater a Miami, demolito dopo una vendita da 12 milioni di dollari mentre GTA6 era ancora in sviluppo. Annunci Zillow d'archivio della proprietà sembrano confermare che Rockstar ne abbia ricreato non solo l'esterno ma anche la disposizione interna. Si tratta di una scoperta della community, non confermata da Rockstar." },
    { id: "news_073", titolo: "Miami valuta 6 cartelloni pubblicitari a tema GTA6 in centro città", tipo: "ufficiale", categoria: "Annunci", data: "2026-09-04", testo: "La città di Miami sta valutando un'ordinanza che permetterebbe a Rockstar di affittare fino a sei cartelloni pubblicitari nel centro cittadino a tema GTA6, al costo di 202.000 dollari l'uno, per un totale di circa 1,2 milioni di dollari. I proventi finanzierebbero un progetto di riqualificazione di un parco cittadino. La proposta, distinta da quella più ampia della Contea di Miami-Dade su aeroporto e trasporti (che ha già incontrato l'opposizione di sceriffo, commissario e giudice capo), non ha ancora ricevuto un'approvazione formale." },
    { id: "news_072", titolo: "Rob Nelson: la visuale in prima persona completa non c'è, \"per ora\"", tipo: "ufficiale", categoria: "Gameplay", data: "2026-09-04", testo: "Content creator che hanno provato le build di anteprima di GTA6 segnalano l'assenza di una modalità in prima persona completa per esplorare Leonida. Rob Nelson, co-responsabile di Rockstar North, ha confermato che al momento non è implementata, spiegando che lo studio ha concentrato gli sforzi sulle animazioni in terza persona di Jason e Lucia, ma senza escluderla del tutto in futuro (\"per ora\"). Resta comunque disponibile la mira in prima persona con alcune armi, già annunciata in precedenza." },
    { id: "news_071", titolo: "Le interazioni con gli NPC vanno \"molto oltre\" quelle di Red Dead Redemption 2", tipo: "ufficiale", categoria: "Gameplay", data: "2026-09-02", testo: "Rob Nelson ha spiegato che il sistema di interazione con gli NPC introdotto in Red Dead Redemption 2 torna in GTA6 in versione molto più evoluta: sarà possibile salutare o provocare i passanti con dialoghi contestuali, e gli NPC noteranno se ci si sofferma troppo vicino a un gruppo per origliare, reagendo con aggressività o allontanandosi. Secondo Nelson, l'idea nata su un mondo più piccolo e meno popolato come quello di Red Dead Redemption 2 è stata ora portata su scala molto più ampia grazie anche a un team dedicato alla realizzazione degli NPC." },
    { id: "news_070", titolo: "Confermato il ritorno del sistema peso/forma fisica in stile San Andreas", tipo: "ufficiale", categoria: "Gameplay", data: "2026-08-26", testo: "In un'intervista a Dazed, il team di Rockstar ha confermato che Jason e Lucia cambieranno aspetto fisico in base alle scelte del giocatore, riportando un sistema assente dai tempi di San Andreas (2004): mangiare troppo cibo spazzatura fa ingrassare i personaggi, allenarsi in palestra tonifica e fa dimagrire, mentre la privazione del sonno (ad esempio durante fughe dalla polizia di più giorni o \"maratone\" di missioni) si riflette visibilmente sul volto. Rob Nelson ha detto che il team \"guarda ai giochi precedenti con occhio critico\" per migliorare ciò che non era stato curato abbastanza." },
    { id: "news_069", titolo: "Smentito (per ora): nessuna prova che il leaker CyberLeek sia stato arrestato", tipo: "ufficiale", categoria: "Annunci", data: "2026-09-04", testo: "Nei giorni scorsi ha circolato online la voce che CyberLeek, il gruppo/persona dietro i principali leak di gameplay di GTA6, fosse stato arrestato. La notizia nasce da un commento ironico pubblicato sotto un post Reddit tedesco su un caso di cybercrime totalmente scollegato, poi frainteso e rilanciato come se fosse una notizia reale. Nessuna fonte affidabile ha confermato l'arresto: anzi, secondo diverse testate CyberLeek risultava ancora attivo pochi giorni prima, con la pubblicazione di nuovo materiale. Al momento la voce va considerata infondata, in attesa di eventuali sviluppi reali nelle indagini di Take-Two (vedi il restringimento della caccia a una o due persone)." },
    { id: "news_068", titolo: "Rumor: una teoria virale indica l'8 (o il 4) novembre per il terzo trailer", tipo: "rumor", categoria: "Annunci", data: "2026-09-04", testo: "Diversi fan hanno rilanciato una teoria numerologica basata su dettagli visivi dei trailer già usciti: l'orologio di Jason nel secondo trailer segnerebbe le 11:08, letto come riferimento all'8 novembre (data in cui fu annunciato anche il primissimo trailer di GTA6, nel 2023); altri notano che sulla pagina ufficiale aggiornata di recente l'orologio segna 14:42 (la cui somma delle cifre fa 11) accanto all'ombra di una statua a forma di \"4\", letta come 4 novembre. Rockstar non ha commentato né confermato alcuna data per un nuovo trailer: resta una speculazione dei fan, senza alcuna base ufficiale." },
    { id: "news_067", titolo: "Sceriffo e commissario di Miami-Dade si oppongono al piano \"Vice City Airport\"", tipo: "ufficiale", categoria: "Annunci", data: "2026-09-03", testo: "Dopo la notizia della proposta di Rockstar alla contea di Miami-Dade per un rebranding in stile Vice City dell'aeroporto e di altre infrastrutture, lo sceriffo della contea Rosie Cordero-Stutz e il commissario JC Bermudez si sono espressi pubblicamente contro il piano, sostenendo che la contea dovrebbe promuovere la Miami reale per cui si lavora ogni giorno, non una versione fittizia associata a crimine e violenza. La proposta resta quindi in una fase di stallo, senza alcuna approvazione formale." },
    { id: "news_066", titolo: "Confermato: il rifornimento di carburante è una meccanica di gioco completa", tipo: "ufficiale", categoria: "Gameplay", data: "2026-09-03", testo: "Rob Nelson, co-responsabile di Rockstar North, ha confermato durante le anteprime private che il rifornimento di carburante sarà una meccanica reale in GTA6: fermandosi a un distributore si potrà scegliere se riparare il veicolo o fare rifornimento, con un breve minigioco a tempo di circa 10 secondi e un'animazione dedicata. I veicoli elettrici si ricaricano invece alle colonnine. Nelson ha detto di aspettarsi reazioni contrastanti dai giocatori, ma ritiene il sistema abbastanza rapido da non risultare fastidioso." },
    { id: "news_065", titolo: "Sony annuncia due DualSense a tema GTA6 per PS5", tipo: "ufficiale", categoria: "Annunci", data: "2026-09-03", testo: "Sony e Rockstar hanno presentato due controller DualSense a edizione limitata dedicati a GTA6, in versione nera e bianca, entrambi decorati con palme e tonalità al tramonto ispirate a Vice City e il numero \"VI\" in stile romano sul touchpad. I due modelli richiamano rispettivamente il giorno e la vita notturna di Vice City. Costeranno 84,99$ ciascuno, saranno preordinabili dal 10 settembre sul PlayStation Direct Store e usciranno insieme al gioco il 19 novembre 2026." },
    { id: "news_064", titolo: "L'Extended Look è il titolo più visto su Netflix con 31,1 milioni di visualizzazioni in 4 giorni", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-31", testo: "Secondo i dati ufficiali di Netflix, \"Grand Theft Auto VI: An Extended Look\" ha totalizzato 31,1 milioni di visualizzazioni tra il debutto di giovedì 27 agosto e domenica 30 agosto, risultando il titolo più visto della settimana sulla piattaforma. Il video ha raggiunto la prima posizione nella classifica film in lingua inglese in 87 dei 93 paesi monitorati da Netflix, superando produzioni come \"The Whisper Man\" (23,2 milioni). Il debutto ha inoltre generato un aumento del 24% nei download dell'app Netflix. Su YouTube, dove il video è stato pubblicato sei ore dopo, il solo canale ufficiale Rockstar Games ha superato i 17 milioni di visualizzazioni, con criteri di conteggio diversi rispetto a Netflix." },
    { id: "news_063", titolo: "Confermato: nessuna microtransazione e nessuna IA generativa nel single-player", tipo: "ufficiale", categoria: "Prezzo", data: "2026-08-31", testo: "Il co-responsabile di Rockstar North Rob Nelson ha confermato che la campagna single-player di GTA6, in uscita il 19 novembre, non conterrà microtransazioni né acquisti in-game con denaro reale, e che nel gioco non è stata usata alcuna intelligenza artificiale generativa: l'esperienza è interamente creata a mano dal team. Rockstar ha però evitato di commentare le future modalità di monetizzazione della prossima versione di GTA Online, che negli ultimi anni si è basata sulle Shark Card." },
    { id: "news_062", titolo: "Fuoco di soppressione: la nuova opzione per l'approccio non letale", tipo: "ufficiale", categoria: "Gameplay", data: "2026-08-29", testo: "Rob Nelson, co-responsabile di Rockstar North, ha presentato il \"fuoco di soppressione\": sparare intenzionalmente vicino a un bersaglio senza colpirlo per intimorirlo o confonderlo e guadagnare tempo per scappare. Nelson ha sottolineato che molte missioni offrono alternative non letali, ad esempio portare a termine una rapina entrando senza far scattare l'allarme e andandosene indisturbati. Tra le altre opzioni annunciate: taser, colpi alle braccia o alle gambe per neutralizzare senza uccidere e la possibilità di disarmare un nemico sparando all'arma che impugna. Secondo Nelson evitare completamente la violenza per l'intero gioco resta difficile, vista la natura criminale dei protagonisti, ma il team ha voluto dare più libertà di approccio ai giocatori." },
    { id: "news_061", titolo: "Corsa con L3, armi limitate e mira in stile Dead Eye: nuovi dettagli dalle anteprime", tipo: "ufficiale", categoria: "Gameplay", data: "2026-09-02", testo: "Dalle anteprime private di Rockstar North emergono nuovi dettagli di gameplay: la corsa si attiverà premendo L3 (invece di premere ripetutamente X/A come nei GTA precedenti), la ruota delle armi diventa limitata a due armi lunghe e due pistole nascoste alla volta (le altre vanno riposte nel bagagliaio o in un rifugio), e la mira offre una modalità al rallentatore in stile Dead Eye di Red Dead Redemption 2, oltre alla possibilità di passare in prima persona con alcune armi. I dettagli arrivano da più content creator presenti agli eventi hands-on di Rockstar e non sono ancora stati confermati in un comunicato ufficiale." },
    { id: "news_060", titolo: "NPC con reazioni dinamiche alle rapine: dettagli dalle anteprime hands-on", tipo: "ufficiale", categoria: "Gameplay", data: "2026-09-02", testo: "Rockstar non segnalerà più ogni possibile evento sulla mappa con un'icona: molte situazioni casuali, come rapine improvvisate o incontri di strada, nasceranno spontaneamente dalle routine degli NPC. Durante le rapine, gli ostaggi presenti sulla scena avranno reazioni individuali e non più uniformi: alcuni obbediranno e nasconderanno il volto, altri andranno nel panico urlando, mentre alcuni potrebbero tentare di reagire di nascosto o avvisare le autorità. I dettagli arrivano dalle anteprime hands-on di Rockstar North mostrate a giornalisti e content creator dopo l'Extended Look." },
    { id: "news_059", titolo: "Il processo tra Rockstar e il sindacato IWGB inizia il 10 settembre", tipo: "ufficiale", categoria: "Annunci", data: "2026-09-01", testo: "Un tribunale del lavoro di Glasgow ha respinto il tentativo di Rockstar di far cadere alcune accuse di \"blacklisting\" (l'esclusione mirata di ex dipendenti sindacalizzati dalle assunzioni) mosse dal sindacato IWGB dopo il licenziamento di 31 lavoratori britannici nell'ottobre 2025. Tutte le accuse legate all'attività antisindacale procederanno quindi a un processo completo, fissato dal 10 settembre al 15 ottobre 2026, a poche settimane dal lancio di GTA6 il 19 novembre. Il sindacato chiede reintegro, arretrati e riconoscimento sindacale ufficiale negli studi UK di Rockstar; l'azienda non ha commentato pubblicamente l'esito dell'udienza preliminare." },
    { id: "news_058", titolo: "Take-Two restringe la caccia al leaker di GTA6 a una o due persone", tipo: "ufficiale", categoria: "Annunci", data: "2026-09-01", testo: "Secondo nuovi documenti giudiziari, Take-Two avrebbe ristretto le indagini sui leak di gameplay di GTA6 a una o due persone identificate, dopo mesi di subpoena rivolte a Discord e Microsoft. La nuova richiesta è stata depositata sotto sigillo per evitare che i sospettati distruggano prove. Il materiale trapelato resta comunque diffuso online e non recuperabile: secondo alcune fonti il gruppo CyberLeek avrebbe guadagnato oltre 200.000 dollari tramite uno schema legato a criptovalute prima di sparire. Nonostante i leak, i preordini di GTA6 sarebbero cresciuti di circa il 570% dopo l'Extended Look, segno che il danno commerciale sarebbe limitato." },
    { id: "news_056", titolo: "Confermato: il piano di rebranding \"Vice City\" per Miami-Dade è una proposta reale", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-30", testo: "È stata resa nota una presentazione ufficiale del 29 giugno 2026 con cui Rockstar avrebbe proposto alla Contea di Miami-Dade un pacchetto di iniziative di marketing a tema Vice City: dall'aeroporto internazionale (aerei e aree bagagli a tema) ai treni Metromover e Metrorail, dal porto (ispirato al Port Gellhorn di gioco) a manhole e cabine elettriche nel centro di Miami/Brickell, fino a un festival di auto d'epoca e uno studio radiofonico a tema Vice City. La proposta resta in fase di valutazione, senza approvazione formale, e ha già incontrato l'opposizione di sceriffo, commissario e giudice capo della contea (vedi le notizie collegate)." },
    { id: "news_054", titolo: "Un palazzo identico a quello di Dexter avvistato nell'Extended Look", tipo: "rumor", categoria: "Ambientazione", data: "2026-08-29", testo: "Analizzando fotogramma per fotogramma l'Extended Look, alcuni fan hanno notato un edificio sul lungomare di Vice City dalla forma identica al celebre palazzo di Dexter Morgan nella serie TV Dexter. Rockstar non ha confermato che si tratti di un riferimento intenzionale, quindi per ora resta un semplice easter egg individuato dalla community." },
    { id: "news_053", titolo: "Digital Foundry: i 30 fps sono il prezzo del \"gioco più impressionante mai visto\"", tipo: "ufficiale", categoria: "Gameplay", data: "2026-08-29", testo: "In un'analisi tecnica dell'Extended Look, Digital Foundry sostiene che i 30 fps su console siano il costo inevitabile di quella che definisce la simulazione in tempo reale più impressionante mai vista in un videogioco. Secondo l'analisi, il collo di bottiglia non è la scheda grafica ma la CPU, sommersa dal carico di centinaia di NPC reattivi, folle dense, simulazione fisica e di vita quotidiana che girano tutte insieme in continuazione. Poiché PS5 Pro condivide la stessa CPU della PS5 base, Digital Foundry ritiene improbabile un salto a 60 fps anche su quella console." },
    { id: "news_052", titolo: "600.000 animazioni per gli NPC: il doppio di Red Dead Redemption 2", tipo: "ufficiale", categoria: "Personaggi", data: "2026-08-28", testo: "Rockstar ha rivelato di aver creato un team dedicato, con base a Los Angeles, composto da sceneggiatori, registi e produttori con l'unico compito di rendere più realistici i personaggi non giocanti. Il risultato sono oltre 600.000 animazioni uniche per gli NPC, contro le 55.000 di GTA V e le circa 300.000 di Red Dead Redemption 2. Secondo il co-responsabile di Rockstar North Aaron Garbut, ogni stanza del gioco è stata pensata nel dettaglio: chi ci si siede, cosa beve, i segni lasciati su un tavolo e persino le foto di famiglia appese alle pareti." },
    { id: "news_051", titolo: "Rockstar pubblica 48 fotogrammi in 4K dell'Extended Look", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-28", testo: "Dopo la diretta del 27 agosto, Rockstar ha rilasciato 48 fotogrammi selezionati in altissima risoluzione (4K) catturati dalla build PS5 dell'Extended Look, in ordine cronologico dalla sequenza iniziale nell'appartamento fino alla scena finale sul lungomare. Le immagini mostrano da vicino Jason e Lucia, rapine, inseguimenti della polizia e diverse attività disponibili in giro per Leonida." },
    { id: "news_050", titolo: "Una run completa dura circa 80 ore, la più lunga di sempre per Rockstar", tipo: "ufficiale", categoria: "Gameplay", data: "2026-08-28", testo: "Rob Nelson ha raccontato di aver completato personalmente GTA6 a febbraio 2026 in circa 80 ore, includendo la storia principale e alcuni obiettivi facoltativi con conseguenze narrative. Il numero è indicativo e non un tempo di completamento garantito per tutti: chi si concentra solo sulla trama principale potrebbe finire molto più in fretta, mentre chi vuole esplorare ogni angolo di Leonida potrebbe metterci molto di più. Per confronto, la sola storia di GTA V dura circa 30 ore." },
    { id: "news_049", titolo: "Confermati 30 fps su console, il 60 fps resta in dubbio", tipo: "ufficiale", categoria: "Gameplay", data: "2026-08-28", testo: "Il co-responsabile dello sviluppo Rob Nelson ha dichiarato al content creator brasiliano Davy Jones che le build attuali di GTA6 girano a 30 fotogrammi al secondo su PS5 e Xbox Series X|S (inclusa PS5 Pro). Alla domanda su un'eventuale modalità a 60 fps, Nelson ha risposto che serve prima il parere del team tecnico, senza escluderla né confermarla. Sia GTA V sia Red Dead Redemption 2 erano usciti a 30 fps su console, raggiungendo i 60 fps solo in un secondo momento su hardware più recente." },
    { id: "news_048", titolo: "L'Extended Look manda in tilt Netflix per qualche minuto", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-27", testo: "Al lancio della diretta, alle 15:00 ora della costa est USA del 27 agosto, l'ondata di accessi simultanei ha mandato in errore per circa 3 minuti sia la pagina dell'Extended Look sia la home di Netflix in tutto il mondo, prima che il servizio tornasse regolare. Solo su Twitch, nei minuti precedenti alla diretta, gli streamer che stavano per commentarla avevano già superato gli 881.000 spettatori combinati." },
    { id: "news_047", titolo: "Tutte le chicche nascoste nell'Extended Look", tipo: "ufficiale", categoria: "Gameplay", data: "2026-08-27", testo: "Un'analisi frame per frame dell'Extended Look ha fatto emergere dettagli passati inosservati durante la diretta: le interazioni contestuali (aprire un frigorifero, accendere e spegnere le luci) ricordano da vicino Red Dead Redemption 2; la minimappa mostra ora edifici in 3D per orientarsi meglio in verticale; le armi riportano marca e modello (es. \"Moreland 850 Shotgun\"); tornano marchi storici della saga come Sprunk, eCola, i furgoni blindati Gruppe-Sechs e le banche Fleeca. Confermati anche il sudore dei personaggi durante le attività fisiche, un minigioco per forzare i veicoli, la possibilità di cambiare vestiti e indossare maschere al volo tramite la ruota degli oggetti, e persino messaggi di testo con emoji personalizzate tra Jason e Lucia." },
    { id: "news_046", titolo: "Ufficiale: la mappa di Leonida è il doppio di quella di GTA V", tipo: "ufficiale", categoria: "Ambientazione", data: "2026-08-27", testo: "In vista dell'Extended Look, il co-responsabile dello sviluppo di Rockstar Rob Nelson ha confermato che la mappa di Leonida è due volte più grande di quella di GTA V e tre volte quella di Red Dead Redemption 2. Vice City da sola è il doppio di Los Santos, mentre le aree suburbane circostanti sono fino a 11 volte più estese di quelle di GTA V. La cifra chiude ufficialmente il dibattito acceso dalle stime non verificate circolate nei mesi scorsi." },
    { id: "news_045", titolo: "L'Extended Look va in onda: ecco cosa mostra il primo gameplay reveal di GTA6", tipo: "ufficiale", categoria: "Gameplay", data: "2026-08-27", testo: "Il 27 agosto è andato in onda su Netflix (e sei ore dopo su YouTube e sul sito ufficiale) \"Grand Theft Auto VI: An Extended Look\", un video di circa 26 minuti girato interamente in-game su PS5. Il filmato mostra tre missioni, tra cui una fuga da un covo di droga e un inseguimento della polizia con il ritorno del livello di ricercato a sei stelle, oltre a nuove auto e location come Leonida Keys, Port Gellhorn, Ambrosia e Mount Kalaga. Tra le novità di gameplay: Jason ha un'abilità che evidenzia le zone di uccisione (in rosso) o di neutralizzazione (in giallo) dei nemici, e l'aspetto del personaggio cambia visibilmente se si resta ricercati dalla polizia per più giorni di fila." },
    { id: "news_044", titolo: "Rockstar rompe il silenzio sui leak: \"straziante per il team\"", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-26", testo: "Rockstar Games ha pubblicato un comunicato ufficiale sui numerosi leak di gameplay circolati nelle ultime settimane, definendoli \"straziante per il nostro team\" e non il modo in cui avrebbe voluto che i fan vedessero il gioco dopo tanta attesa. Lo studio si è scusato per i tempi lunghi nel mostrare materiale ufficiale e ha ribadito che GTA6 è quasi completo, confermando che la data di uscita del 19 novembre non cambia e che l'Extended Look su Netflix andrà comunque in onda il 27 agosto." },
    { id: "news_043", titolo: "Nuovo leak: negozio di videogiochi e auricolari personalizzabili", tipo: "rumor", categoria: "Gameplay", data: "2026-08-25", testo: "Un'altra clip attribuita al gruppo CyberLeek, non confermata da Rockstar, mostrerebbe Jason entrare in un negozio di videogiochi fisico esplorabile e indossare degli auricolari in stile AirPods personalizzabili, una possibile nuova funzione di personalizzazione dell'abbigliamento. Trattandosi di materiale non ufficiale, i dettagli vanno presi con cautela in attesa di conferme." },
    { id: "news_042", titolo: "Leak: volo notturno su Vice City e anteprima delle radio", tipo: "rumor", categoria: "Gameplay", data: "2026-08-24", testo: "Il gruppo che si fa chiamare CyberLeek ha pubblicato un nuovo video non ufficiale che mostrerebbe un volo notturno sopra Vice City e un'anteprima di alcune stazioni radio del gioco. Rockstar non ha confermato l'autenticità del materiale e ha continuato a farlo rimuovere tramite notifiche DMCA." },
    { id: "news_041", titolo: "Take-Two fa causa a Microsoft e Discord per i leak di GTA6", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-20", testo: "Take-Two ha depositato due richieste di subpoena presso il tribunale del Distretto Sud di New York, chiedendo a Microsoft e Discord di identificare la persona o le persone dietro l'account \"CyberLeek\" responsabile dei recenti leak di gameplay di GTA6. Le richieste, con scadenza fissata al 4 settembre, chiedono dati come indirizzi IP, numeri di telefono, account Xbox e Google collegati e il contenuto di eventuali cartelle OneDrive di chiunque abbia scritto in tre specifici server Discord dal 1° giugno in poi." },
    { id: "news_040", titolo: "Un battaglione dell'esercito USA offre 4 giorni di permesso per giocare a GTA6", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-19", testo: "La 9th Brigade Engineer Battalion della 3rd Infantry Division, di stanza a Fort Stewart in Georgia, sta offrendo ai soldati che firmano un rinnovo di ferma (da 2 a 6 anni) tra il 1° agosto e il 14 novembre 2026 un permesso speciale di 4 giorni da usare in coincidenza con l'uscita di GTA6. Secondo l'unità, circa 20 dei 130 soldati idonei hanno già rinnovato la ferma grazie a questo incentivo." },
    { id: "news_037", titolo: "Smentito il rumor sui tre episodi Netflix dell'Extended Look", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-15", testo: "Un post virale secondo cui l'Extended Look di GTA6 sarebbe stato diviso in tre episodi Netflix (rispettivamente di 23'37\", 24'41\" e 18'29\", per oltre 66 minuti totali) si è rivelato infondato: lo screenshot che citava una presunta pagina Netflix portoghese è stato rimosso insieme all'account che lo aveva pubblicato, e né Rockstar né Netflix hanno mai confermato la suddivisione in episodi. La presentazione resta confermata per il 27 agosto alle 21:00 CEST come singolo evento." },
    { id: "news_036", titolo: "Confermato: il pre-caricamento di GTA6 parte il 12 novembre", tipo: "ufficiale", categoria: "Uscita", data: "2026-08-14", testo: "Rockstar ha confermato che il pre-caricamento di GTA6 sarà disponibile dal 12 novembre 2026, una settimana prima dell'uscita del 19 novembre, sia per chi ha preordinato in digitale sia per chi acquista la copia fisica (che contiene solo un codice, non un disco). Il pre-caricamento scarica in anticipo i file, ma il gioco resterà bloccato fino al giorno del lancio: Rockstar consiglia di liberare per tempo circa 150-200 GB di spazio libero." },
    { id: "news_035", titolo: "Zelnick: a 80$ GTA6 sarà comunque \"un affare incredibile\"", tipo: "ufficiale", categoria: "Prezzo", data: "2026-08-14", testo: "Durante la call sui risultati del primo trimestre fiscale e in una successiva intervista, il CEO di Take-Two Strauss Zelnick ha difeso il prezzo di 79,99$ di GTA6 (10$ in più rispetto allo standard AAA attuale), definendolo \"un affare incredibile\" vista la mole di contenuti. Zelnick ha ribadito che l'obiettivo dell'azienda è \"consegnare sempre molto più valore ai consumatori di quanto viene loro chiesto\", e che Rockstar non sta cercando di \"massimizzare il prezzo\"." },
    { id: "news_033", titolo: "Zelnick: i preordini pendono verso la Ultimate Edition da 100$", tipo: "ufficiale", categoria: "Prezzo", data: "2026-08-10", testo: "In un'intervista a CNBC, Strauss Zelnick ha dichiarato che i preordini di GTA6 stanno \"pendendo verso l'edizione premium\", con la Ultimate Edition da 99,99$ che vende più della Standard da 79,99$. Secondo il CEO di Take-Two, si tratta di un segnale che \"i consumatori più appassionati sono quelli che preordinano adesso\", anche se ha ribadito che i dati sui preordini non sono ancora definitivi." },
    { id: "news_031", titolo: "Zelnick: il reveal Netflix è solo l'antipasto, altri trailer in arrivo", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-10", testo: "In un'intervista a GamesIndustry.biz, il CEO di Take-Two Strauss Zelnick ha paragonato la campagna marketing di GTA6 a un pasto in più portate: l'Extended Look del 27 agosto su Netflix è solo l'\"antipasto\", con \"portata principale e dessert\" ancora da arrivare prima del lancio del 19 novembre. Zelnick non ha specificato la forma dei prossimi reveal, ma ha promesso ulteriori trailer e materiale prima dell'uscita." },
    { id: "news_029", titolo: "Polemiche per il paywall: l'Extended Look sarà esclusiva Netflix per le prime 6 ore", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-10", testo: "Per vedere in anteprima l'Extended Look il 27 agosto servirà un abbonamento Netflix (si parte da 8,99$/mese): solo dopo 6 ore il video sarà pubblicato gratis su YouTube e sul sito ufficiale di GTA VI. La scelta ha scatenato critiche da parte della community, che la definisce un ulteriore passo verso la monetizzazione del marketing, in un contesto già segnato dal prezzo di lancio di 79,99$ (20$ in più rispetto a GTA V nel 2013)." },
    { id: "news_028", titolo: "Netflix conferma: i creator potranno commentare e clippare l'Extended Look da subito", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-09", testo: "Netflix ha confermato al giornalista Steve Vegvari che i content creator saranno liberi di reagire, spezzettare in clip e ripubblicare l'Extended Look di GTA6 non appena andrà in onda il 27 agosto, senza embargo sui contenuti derivati. L'esclusiva riguarda solo chi vede per primo il video, non chi può parlarne: l'obiettivo è far circolare rapidamente reazioni e analisi su tutte le piattaforme." },
    { id: "news_027", titolo: "Sony promuove PS5 Pro in vista di GTA6", tipo: "ufficiale", categoria: "Annunci", data: "2026-08-09", testo: "Su alcune console PS5 base è comparso un banner che invita gli abbonati PS Plus a passare a PS5 Pro con uno sconto del 5% (il prezzo pieno è salito di recente a 899$), in vista del lancio di GTA6 il 19 novembre. La promozione, però, non specifica quali vantaggi concreti offrirà la versione PS5 Pro del gioco: Rockstar non ha ancora rivelato dettagli sulle differenze tecniche tra le due versioni." },
    { id: "news_026", titolo: "Rumor: quando arriverà la versione PC?", tipo: "rumor", categoria: "Uscita", data: "2026-08-09", testo: "Rockstar non ha annunciato né una data né una pagina Steam per la versione PC, ma lo storico della casa (ogni titolo principale dai tempi di GTA IV è arrivato su PC dopo le console) alimenta le stime della community: seguendo i tempi più stretti di Red Dead Redemption 2 si arriverebbe a novembre 2027, mentre ripetendo lo schema di GTA V si arriverebbe a giugno 2028. Nessuna conferma ufficiale in merito." },
    ...
    { id: "news_030", titolo: "Rockstar conferma: i codici retail di GTA6 per PS5 sono legati alla regione, su Xbox no", tipo: "ufficiale", categoria: "Prezzo", data: "2026-08-06", testo: "Rockstar ha aggiornato la pagina di supporto ufficiale chiarendo che i codici di download inclusi nelle copie fisiche di GTA6 per PS5 sono vincolati alla regione dell'account PSN usato per il riscatto, mentre le copie Xbox Series X|S restano riscattabili ovunque senza restrizioni. Rockstar consiglia di acquistare il gioco nello stesso paese o nella stessa area supportata dal proprio account PlayStation per evitare problemi di attivazione del codice." },
...
const NEWS_EN = {
  news_075: { titolo: "Miami-Dade's chief judge also opposes the Vice City branding plan", testo: "Joining the Sheriff and Commissioner's objections to the Vice City-style rebranding plan, Miami-Dade Chief Judge Ariana Fajardo Orshan wrote to Mayor Daniella Levine Cava asking that courthouses and judicial facilities be excluded from any GTA6 branding, arguing the game's themes are incompatible with what those buildings represent. The mayor's office, by contrast, remains open to the proposal as a possible revenue and exposure opportunity, though no formal agreement has been reached." },
  news_074: { titolo: "Fan traces Jason and Lucia's real apartment to a now-demolished building", testo: "By matching the skyline visible through Jason and Lucia's apartment window to Google Maps' historical imagery, a fan traced the building that likely inspired their Vice City home: the Belmar Condominium, a small 13-unit building in Miami's Edgewater neighborhood, demolished after a $12 million sale while GTA6 was still in development. Archived Zillow listings for the property appear to confirm Rockstar recreated not just its exterior but its interior layout too. This is a community discovery, not confirmed by Rockstar." },
  news_073: { titolo: "Miami considers six downtown GTA6-themed billboards", testo: "The City of Miami is weighing an ordinance that would let Rockstar rent up to six downtown billboards themed around GTA6, at $202,000 each for a total of about $1.2 million. The proceeds would fund a downtown park improvement project. The proposal, separate from Miami-Dade County's broader airport-and-transit plan (which has already drawn opposition from the sheriff, a commissioner, and the chief judge), has not yet received formal approval." },
  news_072: { titolo: "Rob Nelson: full first-person view isn't in \"for now\"", testo: "Content creators who tried GTA6's preview builds report the absence of a full first-person mode for exploring Leonida. Rockstar North co-head Rob Nelson confirmed it isn't implemented at the moment, explaining the studio focused its efforts on Jason and Lucia's third-person animations, without fully ruling it out down the line (\"for now\"). First-person aiming with certain weapons, announced earlier, remains available regardless." },
  news_071: { titolo: "NPC interactions go \"much further\" than Red Dead Redemption 2", testo: "Rob Nelson explained that the NPC interaction system introduced in Red Dead Redemption 2 returns in GTA6 in a far more evolved form: players will be able to greet or antagonize passersby through contextual dialogue, and NPCs will notice if you linger too close to a group to eavesdrop, reacting with aggression or by walking away. According to Nelson, the idea born in Red Dead Redemption 2's smaller, sparser world has now been scaled up dramatically, helped by a dedicated team built around realistic NPCs." },
  news_070: { titolo: "San Andreas-style weight and fitness system confirmed to return", testo: "In an interview with Dazed, Rockstar's team confirmed that Jason and Lucia will visibly change based on player choices, bringing back a system absent since San Andreas (2004): eating too much fast food makes the characters gain weight, working out at the gym tones muscle and slims them down, while sleep deprivation (say, from multi-day police chases or mission \"benders\") shows visibly on their faces. Rob Nelson said the team \"looks back at our previous games with a critical eye\" to improve on what wasn't handled as fully before." },
  news_069: { titolo: "Debunked (for now): no evidence GTA6 leaker CyberLeek was arrested", testo: "A rumor has circulated online in recent days claiming CyberLeek, the group/person behind the major GTA6 gameplay leaks, was arrested. The claim traces back to a joking comment posted under an unrelated German Reddit post about a separate cybercrime case, which was then misread and spread as if it were real news. No credible outlet has confirmed an arrest — if anything, several sources reported CyberLeek was still active just days earlier, posting new material. For now the rumor should be treated as unfounded, pending any real developments in Take-Two's ongoing investigation (see the narrowing of the leaker hunt to one or two people)." },
  news_068: { titolo: "Rumor: a viral theory points to November 8 (or 4) for a third trailer", testo: "Fans have revived a numerology theory based on visual details from the trailers already released: Jason's watch in the second trailer reportedly reads 11:08, read as a nod to November 8 (also the date the very first GTA6 trailer was announced back in 2023); others point to the recently updated official website, where a watch shows 14:42 (whose digits sum to 11) next to a statue's shadow shaped like a \"4,\" read as November 4. Rockstar hasn't commented on or confirmed any date for a new trailer: this remains pure fan speculation with no official basis." },
  news_067: { titolo: "Miami-Dade sheriff and commissioner push back on the \"Vice City Airport\" plan", testo: "Following news of Rockstar's pitch to Miami-Dade County for a Vice City-themed rebrand of the airport and other infrastructure, County Sheriff Rosie Cordero-Stutz and Commissioner JC Bermudez publicly spoke out against the plan, arguing the county should be promoting the real Miami it works hard to build, not a fictional version associated with crime and violence. The proposal remains stalled, with no formal approval given." },
  news_066: { titolo: "Confirmed: fuel refueling is a full gameplay mechanic", testo: "Rockstar North co-head Rob Nelson confirmed during hands-on previews that refueling will be a real mechanic in GTA6: pulling into a gas station lets you choose to repair your vehicle or refuel it, triggering a short roughly 10-second timed mini-game with a dedicated animation. Electric vehicles recharge at charging stations instead. Nelson said he expects mixed reactions from players but thinks the system is fast enough that \"you can't really complain.\"" },
  news_065: { titolo: "Sony announces two GTA6-themed DualSense controllers for PS5", testo: "Sony and Rockstar unveiled two limited-edition DualSense controllers themed around GTA6, in black and white, both featuring palm tree details and Vice City sunset colors plus a Roman-numeral \"VI\" on the touchpad. The two designs represent Vice City's daytime and nightlife respectively. Each will cost $84.99, go up for pre-order on September 10 via the PlayStation Direct Store, and launch alongside the game on November 19, 2026." },
  news_064: { titolo: "The Extended Look becomes Netflix's most-watched title with 31.1 million views in 4 days", testo: "According to official Netflix data, \"Grand Theft Auto VI: An Extended Look\" racked up 31.1 million views between its Thursday, August 27 debut and Sunday, August 30, making it the platform's most-watched title of the week. The video topped the English-language film chart in 87 of the 93 countries Netflix tracks, ahead of titles like \"The Whisper Man\" (23.2 million). The premiere also drove a 24% spike in Netflix app downloads. On YouTube, where the video went up six hours later, Rockstar's official channel alone topped 17 million views, though the two platforms count views differently." },
  news_063: { titolo: "Confirmed: no microtransactions and no generative AI in the single-player", testo: "Rockstar North co-head Rob Nelson confirmed that GTA6's single-player campaign, launching November 19, will contain no microtransactions or real-money in-game purchases, and that no generative AI was used in making the game: the experience is entirely handcrafted by the team. Rockstar declined to comment on the future monetization of the next version of GTA Online, which has relied on Shark Cards for years." },
  news_062: { titolo: "Suppressive fire: the new option for a non-lethal approach", testo: "Rockstar North co-head Rob Nelson introduced \"suppressive fire\": intentionally shooting near a target without hitting it to intimidate or confuse them and buy time to escape. Nelson stressed that many missions offer non-lethal alternatives, such as pulling off a robbery by breaking in without triggering the alarm and leaving undetected. Other announced options include taser guns, shooting enemies in the arms or legs to incapacitate without killing, and disarming an opponent by shooting the weapon out of their hand. Nelson noted that avoiding violence entirely throughout the whole game remains difficult given the protagonists' criminal backgrounds, but the team wanted to give players more freedom in how they approach situations." },
  news_061: { titolo: "L3 sprint, limited weapons and Dead-Eye-style aiming: new details from previews", testo: "New gameplay details have emerged from Rockstar North's private previews: sprinting will be triggered by pressing L3 (instead of repeatedly mashing X/A like in past GTA games), the weapon wheel becomes limited to two long guns and two concealed handguns at a time (extras go in the trunk or a safehouse), and aiming offers a Red Dead Redemption 2 Dead-Eye-style slow-motion mode, plus the option to switch to first person with certain weapons. The details were reported by multiple creators who attended Rockstar's hands-on preview events and haven't yet been confirmed in an official Rockstar statement." },
  news_060: { titolo: "NPCs react dynamically to robberies: details from hands-on previews", testo: "Rockstar will no longer flag every possible event on the map with an icon: many random situations, like improvised robberies or street encounters, will emerge spontaneously from NPC routines. During robberies, hostages on the scene will have individual, no-longer-uniform reactions: some will comply and hide their faces, others will panic and shout, while a few might try to secretly resist or alert the authorities. The details come from Rockstar North's hands-on previews shown to journalists and content creators after the Extended Look." },
  news_059: { titolo: "The Rockstar vs. IWGB union trial begins September 10", testo: "A Glasgow employment tribunal rejected Rockstar's attempt to strike out some \"blacklisting\" claims (targeted exclusion of former unionized employees from future hiring) brought by the IWGB union after 31 UK workers were dismissed in October 2025. All the allegations tied to anti-union activity will now proceed to a full trial, set to run from September 10 to October 15, 2026, just weeks before GTA6's November 19 launch. The union is seeking reinstatement, back pay, and formal union recognition across Rockstar's UK studios; the company hasn't publicly commented on the outcome of the preliminary hearing." },
  news_058: { titolo: "Take-Two narrows the GTA6 leaker hunt to one or two people", testo: "According to new court filings, Take-Two has reportedly narrowed its investigation into the GTA6 gameplay leaks down to one or two identified individuals, after months of subpoenas targeting Discord and Microsoft. The new request was filed under seal to prevent the suspects from destroying evidence. The leaked material remains widely spread online and can't be recovered either way: some sources claim the group behind it, CyberLeek, earned over $200,000 through a cryptocurrency scheme before disappearing. Despite the leaks, GTA6 pre-orders reportedly grew about 570% after the Extended Look aired, suggesting the commercial damage has been limited." },
  news_056: { titolo: "Confirmed: Miami-Dade's \"Vice City\" rebranding plan is a real proposal", testo: "An official June 29, 2026 presentation has surfaced in which Rockstar reportedly pitched Miami-Dade County a package of Vice City-themed marketing initiatives: from the international airport (themed planes and baggage areas) to Metromover and Metrorail trains, from the port (inspired by the game's Port Gellhorn) to manhole covers and utility boxes in downtown Miami/Brickell, plus a classic car festival and a Vice City-themed radio studio. The proposal remains under review with no formal approval, and has already drawn opposition from the county's sheriff, a commissioner, and the chief judge (see related news)." },
  news_054: { titolo: "A building identical to Dexter's apartment spotted in the Extended Look", testo: "Analyzing the Extended Look frame by frame, some fans noticed a waterfront building in Vice City with a shape identical to the famous apartment building from the TV series Dexter. Rockstar hasn't confirmed this as an intentional reference, so for now it remains just an easter egg spotted by the community." },
  news_053: { titolo: "Digital Foundry: 30 fps is the price of the \"most impressive game\" it's ever seen", testo: "In a technical breakdown of the Extended Look, Digital Foundry argues that 30 fps on console is the unavoidable cost of what it calls the most impressive real-time simulation ever seen in a video game. The bottleneck, per the analysis, isn't the GPU but the CPU, overwhelmed by hundreds of reactive NPCs, dense crowds, and physics and life-simulation systems all running constantly at once. Since the PS5 Pro shares the same CPU as the base PS5, Digital Foundry considers a jump to 60 fps unlikely even there." },
  news_052: { titolo: "600,000 NPC animations: twice as many as Red Dead Redemption 2", testo: "Rockstar revealed it built a dedicated, Los Angeles-based team of writers, directors and producers with the sole task of making non-playable characters more realistic. The result is over 600,000 unique NPC animations, compared to 55,000 in GTA V and roughly 300,000 in Red Dead Redemption 2. According to Rockstar North co-head Aaron Garbut, every room in the game was thought through in detail: who's sitting where, what they're drinking, the marks left on a table, and even family photos hanging on the walls." },
  news_051: { titolo: "Rockstar releases 48 4K frames from the Extended Look", testo: "Following the August 27 broadcast, Rockstar released 48 selected ultra-high-resolution (4K) frames captured from the Extended Look's PS5 build, in chronological order from the opening apartment sequence to the closing waterfront scene. The images offer a close look at Jason and Lucia, robberies, police chases, and various activities available around Leonida." },
  news_050: { titolo: "A full playthrough takes about 80 hours, Rockstar's longest yet", testo: "Rob Nelson said he personally completed GTA6 in February 2026 in around 80 hours, including the main story and some optional objectives with narrative consequences. The figure is indicative rather than a guaranteed completion time for everyone: players focused purely on the main story could finish much faster, while those exploring every corner of Leonida could take much longer. For comparison, GTA V's main story alone runs about 30 hours." },
  news_049: { titolo: "30 fps confirmed on console, 60 fps still up in the air", testo: "Co-head of development Rob Nelson told Brazilian content creator Davy Jones that GTA6's current builds run at 30 frames per second on PS5 and Xbox Series X|S (including PS5 Pro). Asked about a possible 60 fps mode, Nelson said the technical team would need to weigh in first, neither ruling it out nor confirming it. Both GTA V and Red Dead Redemption 2 launched at 30 fps on console, reaching 60 fps only later on newer hardware." },
  news_048: { titolo: "The Extended Look briefly breaks Netflix", testo: "When the stream went live at 3:00 PM ET on August 27, the surge of simultaneous viewers caused both the Extended Look page and the Netflix homepage worldwide to briefly error out for about 3 minutes before service returned to normal. On Twitch alone, in the minutes before the stream, streamers preparing to react to it had already drawn a combined 881,000 viewers." },
  news_047: { titolo: "Every hidden detail spotted in the Extended Look", testo: "A frame-by-frame analysis of the Extended Look surfaced details that went unnoticed during the live stream: context-sensitive interactions (opening a fridge, turning lights on and off) closely echo Red Dead Redemption 2; the minimap now shows 3D buildings for better vertical orientation; weapons display brand and model (e.g. \"Moreland 850 Shotgun\"); classic series brands make a comeback, including Sprunk, eCola, Gruppe-Sechs armored vans and Fleeca banks. Also confirmed: characters sweating during physical activities, a mini-game for hotwiring vehicles, the ability to change clothes and put on masks on the fly via the weapon wheel, and even text messages with custom emoji between Jason and Lucia." },
  news_046: { titolo: "Confirmed: Leonida's map is twice the size of GTA V's", testo: "Ahead of the Extended Look, Rockstar co-head of development Rob Nelson confirmed that Leonida's map is twice the size of GTA V's and three times that of Red Dead Redemption 2. Vice City alone is twice the size of Los Santos, while the surrounding suburbs are up to 11 times larger than GTA V's. The figure officially settles the debate sparked by unverified estimates circulating in recent months." },
  news_045: { titolo: "The Extended Look airs: here's what GTA6's first gameplay reveal shows", testo: "On August 27, Netflix (and six hours later YouTube and the official site) aired \"Grand Theft Auto VI: An Extended Look,\" a roughly 26-minute video captured entirely in-game on PS5. The footage shows three missions, including an escape from a drug den and a police chase with the return of the six-star wanted level, plus new cars and locations like the Leonida Keys, Port Gellhorn, Ambrosia and Mount Kalaga. New gameplay details include: Jason has an ability that highlights kill zones (red) or incapacitate zones (yellow) on enemies, and the character's appearance visibly changes after staying wanted by police for several days in a row." },
  news_044: { titolo: "Rockstar breaks its silence on the leaks: \"heartbreaking for the team\"", testo: "Rockstar Games issued an official statement about the wave of gameplay leaks that have circulated over the past weeks, calling them \"heartbreaking for our team\" and not how it wanted fans to see the game after such a long wait. The studio apologized for taking so long to show official material and reiterated that GTA6 is nearly finished, confirming the November 19 release date is unchanged and that the Netflix Extended Look will still air on August 27." },
  news_043: { titolo: "New leak: video game store and customizable earbuds", testo: "Another clip attributed to the CyberLeek group, unconfirmed by Rockstar, reportedly shows Jason entering an explorable brick-and-mortar video game store and wearing customizable AirPods-style earbuds, a possible new clothing customization feature. Since this is unofficial material, the details should be treated with caution pending confirmation." },
  news_042: { titolo: "Leak: nighttime flight over Vice City and a radio stations preview", testo: "The group calling itself CyberLeek published another unofficial video reportedly showing a nighttime flight over Vice City and a preview of some of the game's radio stations. Rockstar hasn't confirmed the material's authenticity and has continued having it taken down via DMCA notices." },
  news_041: { titolo: "Take-Two sues Microsoft and Discord over the GTA6 leaks", testo: "Take-Two filed two subpoenas in the Southern District of New York, asking Microsoft and Discord to identify the person or people behind the \"CyberLeek\" account responsible for the recent GTA6 gameplay leaks. The requests, with a September 4 deadline, seek data such as IP addresses, phone numbers, linked Xbox and Google accounts, and the contents of any OneDrive folders belonging to anyone who posted in three specific Discord servers since June 1." },
  news_040: { titolo: "A US Army battalion offers 4 days off to play GTA6", testo: "The 3rd Infantry Division's 9th Brigade Engineer Battalion, based at Fort Stewart, Georgia, is offering soldiers who sign a 2-to-6-year reenlistment contract between August 1 and November 14, 2026 a special 4-day pass to use around GTA6's launch. According to the unit, about 20 of the 130 eligible soldiers have already reenlisted for this incentive." },
  news_037: { titolo: "Debunked: the Netflix three-episode Extended Look rumor", testo: "A viral post claiming GTA6's Extended Look would be split into three Netflix episodes (23:37, 24:41 and 18:29, for over 66 minutes total) turned out to be false: the screenshot citing an alleged Portuguese Netflix listing was deleted along with the account that posted it, and neither Rockstar nor Netflix ever confirmed an episode split. The presentation remains confirmed as a single event on August 27 at 9 PM CEST." },
  news_036: { titolo: "Confirmed: GTA6 pre-load starts November 12", testo: "Rockstar has confirmed that GTA6 pre-loading will be available from November 12, 2026, one week before the November 19 launch, for both digital pre-orders and physical copies (which contain only a code, not a disc). Pre-loading downloads the files early, but the game stays locked until launch day: Rockstar recommends clearing about 150-200 GB of free space ahead of time." },
  news_035: { titolo: "Zelnick: at $80, GTA6 will still be \"an incredible bargain\"", testo: "During the first fiscal quarter earnings call and a follow-up interview, Take-Two CEO Strauss Zelnick defended GTA6's $79.99 price ($10 above the current AAA standard), calling it \"an incredible bargain\" given the amount of content. Zelnick reiterated that the company's goal is to \"deliver way more value to consumers than what we charge,\" and that Rockstar isn't trying to \"maximize price.\"" },
  news_033: { titolo: "Zelnick: pre-orders skew toward the $100 Ultimate Edition", testo: "In an interview with CNBC, Strauss Zelnick said GTA6 pre-orders are \"skewing toward the premium edition,\" with the $99.99 Ultimate Edition outselling the $79.99 Standard Edition. According to the Take-Two CEO, this signals that \"the most avid consumers are the ones pre-ordering now,\" though he reiterated that pre-order data isn't final yet." },
  news_031: { titolo: "Zelnick: the Netflix reveal is just the appetizer, more trailers to come", testo: "In an interview with GamesIndustry.biz, Take-Two CEO Strauss Zelnick compared GTA6's marketing campaign to a multi-course meal: the August 27 Extended Look on Netflix is only the \"appetizer,\" with \"main course and dessert\" still to come before the November 19 launch. Zelnick didn't specify what form the next reveals will take, but promised more trailers and footage before release." },
  news_029: { titolo: "Backlash over the paywall: the Extended Look is Netflix-exclusive for the first 6 hours", testo: "Watching the Extended Look live on August 27 will require a Netflix subscription (starting at $8.99/month): only after 6 hours will the video go up for free on YouTube and the official GTA VI website. The move has drawn criticism from the community, who call it another step toward monetizing marketing, on top of the $79.99 launch price already $20 higher than GTA V's in 2013." },
  news_028: { titolo: "Netflix confirms: creators can react to and clip the Extended Look right away", testo: "Netflix has confirmed to journalist Steve Vegvari that content creators will be free to react to, clip, and repost the GTA6 Extended Look the moment it airs on August 27, with no embargo on derivative content. The exclusivity only covers who sees the video first, not who can talk about it: the goal is to spread reactions and analysis quickly across every platform." },
  news_027: { titolo: "Sony pushes PS5 Pro upgrades ahead of GTA6", testo: "Some base PS5 consoles have started showing a banner inviting PS Plus subscribers to upgrade to a PS5 Pro at a 5% discount (full price recently rose to $899) ahead of GTA6's November 19 launch. The promotion doesn't specify what concrete benefits the PS5 Pro version will offer: Rockstar hasn't yet revealed technical differences between the two versions." },
  news_026: { titolo: "Rumor: when will the PC version arrive?", testo: "Rockstar hasn't announced a date or a Steam page for the PC version, but the studio's track record (every mainline title since GTA IV has come to PC after consoles) is fueling community estimates: following Red Dead Redemption 2's tighter timeline points to around November 2027, while repeating GTA V's pattern points to June 2028. No official confirmation either way." },
  ...
  news_030: { titolo: "Rockstar confirms: GTA6 PS5 retail codes are region-locked, Xbox isn't", testo: "Rockstar updated its official support page to clarify that download codes included in physical GTA6 copies for PS5 are tied to the region of the PSN account used to redeem them, while Xbox Series X|S copies can be redeemed anywhere with no restrictions. Rockstar recommends buying the game in the same country or supported region as your PlayStation account to avoid code activation issues." },
