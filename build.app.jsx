...
const DATA = {
  ...
  news: [
    ...
    { id: "news_056", titolo: "Miami-Dade propone di trasformare l'aeroporto e le strade in una vera Vice City", tipo: "rumor", categoria: "Annunci", data: "2026-08-30", testo: "Secondo diverse testate USA, Rockstar avrebbe proposto alla contea di Miami-Dade una collaborazione di marketing per trasformare temporaneamente location reali come l'aeroporto internazionale di Miami, il porto e alcune stazioni della metropolitana in scenografie a tema Vice City (bagagli, carrelli e cartellonistica personalizzati). Un portavoce della contea ha precisato che \"nulla è stato formalmente approvato\" e che l'idea dovrà passare l'iter di revisione ufficiale: per ora resta solo una proposta, non una conferma." },
...
const NEWS_EN = {
  ...
  news_056: { titolo: "Miami-Dade pitches turning the airport and streets into a real Vice City", testo: "According to several US outlets, Rockstar reportedly pitched Miami-Dade County a marketing partnership to temporarily rebrand real locations — Miami International Airport, the port, and some Metrorail stations — with Vice City theming (custom baggage claim, carts, and signage). A county spokesperson said \"nothing has been formally agreed to or approved\" and that any plan still needs to go through official review, so for now it's only a pitch, not a confirmation." },
