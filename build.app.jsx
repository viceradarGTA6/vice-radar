...
const DATA = {
  ...
  news: [
    ...
    { id: "news_057", titolo: "I preordini di GTA6 esplodono del 436% dopo l'Extended Look su Netflix", tipo: "rumor", categoria: "Prezzo", data: "2026-08-31", testo: "Secondo le stime di Sensor Tower, i preordini di GTA6 sono aumentati del 436% subito dopo la messa in onda dell'Extended Look su Netflix il 27 agosto. Il salto premia soprattutto PS5, che varrebbe circa il 77% delle vendite stimate (Xbox al 23%). Sensor Tower stima un totale cumulativo di circa 4,55 milioni di copie preordinate, per un giro d'affari di circa 446 milioni di dollari. Trattandosi di stime di terze parti e non di dati ufficiali Rockstar o Take-Two, i numeri vanno considerati indicativi." },
    ...
    { id: "news_039", titolo: "Un gruppo di leaker chiamato CyberLeek pubblica gameplay e la mappa completa", tipo: "rumor", categoria: "Ambientazione", data: "2026-08-18", testo: "Dal 18 agosto un account che si fa chiamare CyberLeek ha iniziato a pubblicare materiale non autorizzato di GTA6, tra cui filmati di gameplay e immagini che sosterrebbero di mostrare la mappa completa di Leonida. Il leaker dichiara di agire in protesta contro la scelta di Rockstar di includere solo un codice (e non un disco) nelle copie fisiche del gioco. Le stime sulla dimensione della mappa ricavate da questo materiale non ufficiale variano molto da fonte a fonte (tra 1,7 e 2,7 volte quella di GTA V) e non sostituiscono una conferma ufficiale di Rockstar. Take-Two ha iniziato a inviare notifiche DMCA per far rimuovere i contenuti." },
    { id: "news_038", titolo: "Un analista: i preordini potrebbero già ripagare l'intero budget di GTA6", tipo: "rumor", categoria: "Prezzo", data: "2026-08-16", testo: "Secondo Karl Kontus di Sensor Tower, se GTA6 raggiungesse i 25 milioni di preordini entro il lancio del 19 novembre, il gioco incasserebbe circa 2 miliardi di dollari, una cifra sufficiente a coprire l'intero costo di produzione e gran parte del budget marketing. Al momento Sensor Tower stima però intorno a 4,3 milioni di preordini, ben lontano dalla soglia ipotizzata, e va ricordato che Rockstar e Take-Two non hanno mai reso pubblico il vero costo di sviluppo del gioco." },
    ...
    { id: "news_032", titolo: "Rockstar segue in segreto sei grandi streamer prima dell'Extended Look", tipo: "rumor", categoria: "Annunci", data: "2026-08-11", testo: "Nei giorni precedenti alla presentazione Netflix del 27 agosto, gli account social di Rockstar Games hanno iniziato a seguire sei streamer di primo piano: Jynxzi, MoistCr1TiKaL, Valkyrae, Fuslie, TimTheTatman e xQc. La mossa non è stata annunciata né spiegata ufficialmente, ma la community la interpreta come un segnale di una campagna di marketing con content creator in arrivo attorno al reveal." },
...
const NEWS_EN = {
  ...
  news_057: { titolo: "GTA6 pre-orders jump 436% after the Netflix Extended Look", testo: "According to Sensor Tower estimates, GTA6 pre-orders rose 436% immediately after the Extended Look aired on Netflix on August 27. The spike favors PS5, estimated at around 77% of sales versus 23% for Xbox. Sensor Tower puts cumulative pre-orders at roughly 4.55 million copies, worth about $446 million. Since these are third-party estimates rather than official Rockstar or Take-Two figures, treat the numbers as indicative." },
  ...
  news_039: { titolo: "A leaker group called CyberLeek posts gameplay and the full map", testo: "Starting August 18, an account calling itself CyberLeek began posting unauthorized GTA6 material, including gameplay footage and images claimed to show the complete map of Leonida. The leaker says they're acting in protest of Rockstar's decision to include only a code, not a disc, in physical copies of the game. Size estimates for the map drawn from this unofficial material vary widely between sources (from 1.7x to 2.7x GTA V's), and none of it replaces an official confirmation from Rockstar. Take-Two has started sending DMCA notices to get the content taken down." },
  news_038: { titolo: "Analyst: pre-orders alone could already cover GTA6's entire budget", testo: "According to Sensor Tower's Karl Kontus, if GTA6 reaches 25 million pre-orders by its November 19 launch, the game would gross around $2 billion — enough to cover its entire production cost plus most of the marketing budget. Sensor Tower currently tracks around 4.3 million pre-orders, far short of that threshold, and it's worth noting Rockstar and Take-Two have never disclosed the game's actual development cost." },
  ...
  news_032: { titolo: "Rockstar quietly follows six major streamers ahead of the Extended Look", testo: "In the days before the August 27 Netflix presentation, Rockstar Games' social accounts started following six high-profile streamers: Jynxzi, MoistCr1TiKaL, Valkyrae, Fuslie, TimTheTatman and xQc. The move hasn't been officially announced or explained, but the community reads it as a sign of an upcoming content-creator marketing push tied to the reveal." },
