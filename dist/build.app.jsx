...
const DATA = {
  ...
  news: [
    ...
    { id: "news_055", titolo: "Rumor: il rifornimento carburante sarà una meccanica di gioco vera e propria", tipo: "rumor", categoria: "Gameplay", data: "2026-08-30", testo: "Secondo l'insider TGG, in GTA6 il rifornimento di carburante sarà una meccanica completa: bisognerà spegnere il motore, scendere dal veicolo e interagire fisicamente con la pompa, tenendo premuto R2/RT per circa 10 secondi con tanto di animazione dedicata e timer a schermo. Restare a secco durante un inseguimento della polizia diventerebbe quindi un rischio concreto. Non essendo materiale confermato da Rockstar, va trattato come rumor in attesa di conferme ufficiali." },
    ...
    { id: "news_034", titolo: "Rumor: un leak promette IA avanzata e missioni cooperative tra Jason e Lucia", tipo: "rumor", categoria: "Gameplay", data: "2026-08-11", testo: "Lo YouTuber HipHopGamer sostiene di aver visto materiale che descrive un'intelligenza artificiale dei NPC molto più reattiva, un sistema di interazione e immersione \"completamente diverso\" da GTA V, e missioni in cui Jason e Lucia possono agire insieme mentre l'altro personaggio è controllato dall'IA. HipHopGamer non è un leaker con uno storico verificato, quindi le informazioni vanno prese con cautela in attesa di conferme ufficiali." },
...
const NEWS_EN = {
  ...
  news_055: { titolo: "Rumor: fuel refueling will be a full gameplay mechanic", testo: "According to insider TGG, refueling in GTA6 will be a complete mechanic: you'll need to kill the engine, get out of the vehicle, and physically interact with the pump, holding R2/RT for about 10 seconds with a dedicated animation and on-screen timer. Running dry mid police chase would become a real risk. Since Rockstar hasn't confirmed this, treat it as a rumor pending official word." },
  ...
  news_034: { titolo: "Rumor: leak claims advanced AI and co-op missions between Jason and Lucia", testo: "YouTuber HipHopGamer claims to have seen material describing much more reactive NPC AI, an interaction and immersion system \"completely different\" from GTA V, and missions where Jason and Lucia can act together while the other character is AI-controlled. HipHopGamer isn't a leaker with a verified track record, so the claims should be treated with caution pending official confirmation." },
